...
#        cam_object.select_set(True)
        ...
        filepath =r"C:\Users\ophelie.abbonato\Documents\SMURFS\Sh_{}".format(cam_object.name)
...
#        cam_object.select_set(True)
        ...
        if not cam_object:
            print("Pas de cam!!!!")
            return{'FINISHED'}
        filepath =filepath =r"C:\Users\ophelie.abbonato\Documents\SMURFS\Sh_{}".format(cam_object.name)
        bpy.ops.import_scene.fbx(filepath = filepath)
...
#        scene.render.filepath =r"C:\Users\ophelie.abbonato\Documents\SMURFS\shot{:03}.png".format(iteration)
        scene.render.filepath =r"C:\Users\ophelie.abbonato\Documents\SMURFS\SMF_112_Sq0001_{}Sh0001_image{:03}.png".format(cam_object.name,iteration)
        bpy.ops.render.opengl(write_still=1)
...
class RenderJpegOperator(bpy.types.Operator):
    ...
    def execute(self,context):
        ...
        scene.render.filepath =r"C:\Users\ophelie.abbonato\Documents\SMURFS\SMF_112_{}Sq0001_image{:03}.jpeg".format(cam_object.name,iteration)
